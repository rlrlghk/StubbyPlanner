...
<meta property="og:url" content="http://www.stubbyplanner.com/planner/planner_rt.asp?trip_id=10289687&tripgene=111011004:3:X,111031001:3:X" />
...
function openInfoWindow2(lat,lng,se)
{
		...
		if(routelist.length==0)
			thtml='<iframe scrolling="no" width="330px" height="110px"  frameborder="0" src="planner_step1_infowindow2.asp?lang=ko&s='+se+'&d='+thedate+'"></iframe>';
		else
			thtml='<iframe scrolling="no" width="330px" height="110px"  frameborder="0" src="planner_step1_infowindow2.asp?lang=ko&s='+se+'&d='+thedate+'"></iframe>';
...
routelist[routelist.length]=new Route('111011004','파리','3','X','0','48.86110101269274','2.3421478271484375',new Date('2019-07-14'),new Date('2019-07-17'));slpRatesArr[routelist[routelist.length-1].cityserial]='4|7|46|24|20';routelist[routelist.length]=new Route('111031001','런던','3','X','0','51.5000874980771','-0.126256942749023',new Date('2019-07-17'),new Date('2019-07-20'));slpRatesArr[routelist[routelist.length-1].cityserial]='5|7|43|25|21';
...
//	//	addCity(title,se,posn.lat(),posn.lng());
	  ...
	  google.maps.event.addListener(marker, 'click', function() {
		...
		infowindow = new google.maps.InfoWindow();
		thtml='<iframe width="350px"  scrolling="no" height="130px" frameborder="0" src="planner_step1_infowindow2.asp?recomm=1&lastcity='+lastcity.serial+'&lang=ko&s='+se+'"></iframe>';
		infowindow.setContent(thtml);
	...
	<div style="background:#3ad195;padding-top:5px;">
		...
		<div style="float:left;width:25%;text-align:right;padding-right:10px;padding-top:5px;padding-bottom:0px;">
			<div onclick="toggleSelectTripWith();" style="cursor:pointer;border:1px solid #efefef;background:#fff;border-radius:2px;;text-align:center;padding-top:5px;padding-bottom:5px;">
				...
				<div style="display:block"><img id="tripwith_img" src="//www.stubbyplanner.com/img_v14/tripwith/TW_1_3.png" height="43px"></div>
...
<div id="map_container" style="float:left;width:75%;height:600px;overflow:hidden">
	<div style="padding-bottom:0px;background:#3ad195">
		...
		<div id="topControllerRight" style="width:100%;">
			<div class="top_menu" id="menu1" onclick="window.location='planner_rt.asp?trip_id=10289687'" style="border-bottom:5px solid gray"><font style="color:#fff;font-size:12pt">루트</font> <span id="menu_label_route" style="border-radius:2px;display:inline-block;background:#fff;padding-top:1px;padding-bottom:1px;padding-left:2px;padding-right:2px;color:#696969;font-size:8pt;">-박-일</span></div>
			...
			<div class="top_menu"  id="menu3" onclick="gotoResv()" ><font style="font-size:12pt;color:#fff;">예약 <span id="menu_label_resv" style="border-radius:2px;display:inline-block;background:#fff;padding-top:1px;padding-bottom:1px;padding-left:2px;padding-right:2px;color:#696969;font-size:8pt;">0만원</span></div>
...
//		zzhtml+="<div class=\"spotbox\" style=\"padding-left:20px;padding-top:2px;padding-right:20px;text-align:left\"></div>";
	...
	var idx=i;
	  google.maps.event.addListener(marker, 'click', function() {
		...
		thtml='<iframe scrolling="no" width="330px" height="110px"  frameborder="0" src="planner_step1_myinfowindow2.asp?idx='+idx+'&lang=ko&s='+cityserial+'"></iframe>';
		infowindow.setContent(thtml);
...
thtml+='<a href="javascript:'+t_select+'"><img src="'+data.bucket_group[i].bucket_list[j].img_url.replace("_m","")+'"  style="border-radius:3px;width:145px;" onerror="this.src=\'/img_v12/img_er.gif\'"></a>';
...
function openTrsLink()
{
	...
	if(curtrstype==5)
		curtrstype=3;
	window.open("/plan/trs_deeplink.asp?lang=ko&date_all="+thedateTxt+"&TRSType="+curtrstype+"&depserial="+curdep+"&desserial="+curdes);
}
...
function addCityBase(cityname,cityserial,lat,lng,recommSlp,is_night_move,slpRates)
{
	...
	$( ".cityblock .cityinfo" ).bind( "click", function() {
		...
		thtml='<iframe scrolling="no" width="330px" height="110px"  frameborder="0" src="planner_step1_myinfowindow2.asp?idx='+idx+'&lang=ko&s='+se+'"></iframe>';
		infowindow.setContent(thtml);
...
실시간으로 수집하고 있습니다</p>
				...
				<div style="text-align:center;background:#d3d3d3;padding-top:15px;padding-bottom:15px;font-size:13pt;font-family:'NanumGothic';color:#696969;line-height:150%">
					...
					<font style="font-size:11pt"><span id="txt_thedate"><b>7월 14일 기준(1개월뒤)</b></span></font>
				</div>
			</div>
		</div>
		<div style="clear:both;"></div>				
