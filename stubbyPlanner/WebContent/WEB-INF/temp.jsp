...
<!-- Meta -->
	...
	<link rel="stylesheet" href="/superguide/One-Pages/assets/css/app.css">
	...
	<link rel="stylesheet" type="text/css" href="/market/css/swiper.min.css">
			...
			<h2 class="stu_h2_title" style="color:gray;line-height:200%;font-weight:500;font-size:16pt"><font style="font-weight:700;">스투비플래너</font>로  <br>유럽여행 경비  17%를 줄여보세요.</h2>
				...
				<div style="padding-top:20px;padding-right:30px;">
					<div style="width:50%;position:relative;display:inline-block;margin-top:8px;vertical-align:middle">
						...
						<a href="/consulting/index.asp" style="text-align:center;width:100%;margin-left:5px;text-decoration:none;font-weight:700;color:#fff;font-size:14pt;display:inline-block;padding:10px 15px;background:#3ad195" onclick="logging('recom','home')"><i class="fa fa-magic" aria-hidden="true"></i> 맞춤여행 의뢰</a>
					</div>
...
<div class="container" style="margin-top:0px;">
	<div style="float:left;width:50%;padding-top:15px;margin-top:25px;padding-bottom:20px;border-bottom:0px solid #efefef;background:#f5f5f5;margin-bottom:10px;padding-left:20px;padding-right:20px;">
		<a href="/market/index.asp"  style="text-decoration:none;font-weight:500;color:gray;width:100%;font-size:14pt;margin-bottom:0px;display:inline-block;padding:10px 15px;border:1px solid #efefef;background:#fff;border-radius:5px;"><font style="color:##3ad195;font-weight:400;font-size:9pt">플래너로 미리 일정을 확정한 사람들을 위한 할인!</font><br> <b>얼리버드특가</b>  <font style="font-size:9pt;color:#3ad195;font-weight:700">빠를수록 커지는 할인율!</font> <i class="fa fa-chevron-right" aria-hidden="true"></i></a>
	</div>
	<div  style="float:left;width:50%;padding-top:15px;margin-top:25px;padding-bottom:20px;border-bottom:0px solid #efefef;background:#f5f5f5;margin-bottom:10px;padding-left:20px;padding-right:20px;">
		<a href="/consulting/index.asp"  style="text-decoration:none;font-weight:500;color:gray;width:100%;font-size:14pt;margin-bottom:0px;display:inline-block;padding:10px 15px;border:1px solid #efefef;background:#fff;border-radius:5px;"><font style="color:##3ad195;font-weight:400;font-size:9pt">첫 유럽 자유여행이라면, 미리 맡겨서 비용을 줄이세요!</font><br>유럽여행 전문가 의뢰 <font style="font-size:9pt;color:#3ad195;font-weight:700">55,200원부터</font> <i class="fa fa-chevron-right" aria-hidden="true"></i></a>
	</div>
</div>
</div>
...
<div style="margin-top:10px;height:300px;background:url('http://d3b39vpyptsv01.cloudfront.net/0/0/1529656417211lU1eOwrfYb.jpg');background-repeat: no-repeat;background-size:cover;background-position:center center;position:relative">
		...
		<div style="position:absolute;top:40px;left:50px;width:500px;height:200px;z-index:9;valign:">
			...
			<p style="margin-top:100px">
				<a href="/planner/view.asp?trip_id=10013676" class="btn-u btn-u-green" style="border-radius:25px;background:#3ad195">이 플래너 자세히 <i class="fa fa-arrow-right"></i></a>
			</p>
...
<div style="margin-top:10px;height:300px;background:url('http://d3b39vpyptsv01.cloudfront.net/0/0/1529656926388R72gaH51HO.jpg');background-repeat: no-repeat;background-size:cover;background-position:center center;position:relative">
		...
		<div style="position:absolute;top:40px;left:50px;width:500px;height:200px;z-index:9;valign:">
			...
			<p style="margin-top:100px">
				<a href="/planner/view.asp?trip_id=10013681" class="btn-u btn-u-green" style="border-radius:25px;background:#3ad195">이 플래너 자세히 <i class="fa fa-arrow-right"></i></a>
			</p>
...
<div style="margin-top:10px;height:300px;background:url('http://d3b39vpyptsv01.cloudfront.net/0/0/1529656420875aoFUHIp5Eo.jpg');background-repeat: no-repeat;background-size:cover;background-position:center center;position:relative">
		<div style="position:absolute;top:0px;left:0px;width:100%;height:300px;background:#000;opacity: 0.25;filter: alpha(opacity=25);"> </div>
		...
		<div style="position:absolute;top:40px;left:50px;width:500px;height:200px;z-index:9;valign:">
			...
			<p style="margin-top:100px">
				<a href="/planner/view.asp?trip_id=10013683" class="btn-u btn-u-green" style="border-radius:25px;background:#3ad195">이 플래너 자세히 <i class="fa fa-arrow-right"></i></a>
			</p>
...
<div style="margin-top:10px;height:300px;background:url('http://d3b39vpyptsv01.cloudfront.net/0/0/1529656413306maGa5t0jvt.jpg');background-repeat: no-repeat;background-size:cover;background-position:center center;position:relative">
		<div style="position:absolute;top:0px;left:0px;width:100%;height:300px;background:#000;opacity: 0.25;filter: alpha(opacity=25);"> </div>
		...
		<div style="position:absolute;top:40px;left:50px;width:500px;height:200px;z-index:9;valign:">
			...
			<p style="margin-top:100px">
				<a href="/planner/view.asp?trip_id=10013685" class="btn-u btn-u-green" style="border-radius:25px;background:#3ad195">이 플래너 자세히 <i class="fa fa-arrow-right"></i></a>
			</p>
...
<div style="margin-top:10px;height:300px;background:url('http://d3b39vpyptsv01.cloudfront.net/0/0/1529656418134cDDvAVssFz.jpg');background-repeat: no-repeat;background-size:cover;background-position:center center;position:relative">
		<div style="position:absolute;top:0px;left:0px;width:100%;height:300px;background:#000;opacity: 0.25;filter: alpha(opacity=25);"> </div>
		...
		<div style="position:absolute;top:40px;left:50px;width:500px;height:200px;z-index:9;valign:">
			...
			<p style="margin-top:100px">
				<a href="/planner/view.asp?trip_id=10005173" class="btn-u btn-u-green" style="border-radius:25px;background:#3ad195">이 플래너 자세히 <i class="fa fa-arrow-right"></i></a>
			</p>
...
<div id="premium_modal" style="display:none; position:fixed; top:0; left:0; right:0; bottom:0; background:rgba(0,0,0,.15); z-index:99999;">
            <div style="position:relative; top:30%; left:50%; transform:translate(-50%, -50%); width:320px; border-radius:2px; box-shadow:0 0 0 1px rgba(0,0,0,.1), 0 2px 8px 0 rgba(0,0,0,.25); background:#fff;">
                <div style="position:relative; height:42px; padding:0 18px; background:#f5f5f7; font-size:15px; font-weight:normal; line-height:42px; color:#4a4a4a;">안내
                    <a href="javascript:closepremiumModal()" class="" style="position:absolute; top:50%; right:20px; transform:translateY(-50%); width:22px; height:22px; background-image:url(https://d3b39vpyptsv01.cloudfront.net/0/0/1548911555427eWBbProQMk.png); background-size:cover;"></a>
                </div>
...
<div id="prime_modal" style="display:none; position:fixed; top:0; left:0; right:0; bottom:0; background:rgba(0,0,0,.15); z-index:99999;">
            <div style="position:relative; top:30%; left:50%; transform:translate(-50%, -50%); width:320px; border-radius:2px; box-shadow:0 0 0 1px rgba(0,0,0,.1), 0 2px 8px 0 rgba(0,0,0,.25); background:#fff;">
                <div style="position:relative; height:42px; padding:0 18px; background:#f5f5f7; font-size:15px; font-weight:normal; line-height:42px; color:#4a4a4a;">안내
                    <a href="javascript:closeprimeModal()" class="" style="position:absolute; top:50%; right:20px; transform:translateY(-50%); width:22px; height:22px; background-image:url(https://d3b39vpyptsv01.cloudfront.net/0/0/1548911555427eWBbProQMk.png); background-size:cover;"></a>
                </div>
...
<div id="prime2_modal" style="display:none; position:fixed; top:0; left:0; right:0; bottom:0; background:rgba(0,0,0,.15); z-index:99999;">
            <div style="position:relative; top:30%; left:50%; transform:translate(-50%, -50%); width:320px; border-radius:2px; box-shadow:0 0 0 1px rgba(0,0,0,.1), 0 2px 8px 0 rgba(0,0,0,.25); background:#fff;">
                <div style="position:relative; height:42px; padding:0 18px; background:#f5f5f7; font-size:15px; font-weight:normal; line-height:42px; color:#4a4a4a;">안내
                    <a href="javascript:closeprime2Modal()" class="" style="position:absolute; top:50%; right:20px; transform:translateY(-50%); width:22px; height:22px; background-image:url(https://d3b39vpyptsv01.cloudfront.net/0/0/1548911555427eWBbProQMk.png); background-size:cover;"></a>
                </div>
