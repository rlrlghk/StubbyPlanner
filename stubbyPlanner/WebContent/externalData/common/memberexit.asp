...
<form name="form" action="/asp/exit.asp" method="post">
...
2. 작성하신 여행계획은 탈퇴전에 직접 [<a href="/plan/profile.asp" target="_blank"><u>내여행리스트</u></a>]에서 삭제해주시기 바랍니다. 삭제방법은 각 여행플래너에서 상단 제목우측에 삭제버튼을 누르시면 됩니다.<br>
3. [<a href="/square/index.asp" target="_blank"><u>광장</u></a>]에 쓰신 글들과 댓글은 자동으로 삭제되지 않으므로 직접 삭제해주시기 바랍니다.<br>
4. 여행정보와 현지교통과 관련해 집필하신 지식글들은 자동으로 삭제되지 않습니다.</font>
</p>
<hr>
<div style="padding-bottom:10px;">비밀번호 : <input class="input" class="form-control" style="border:1px solid #696969" type=password size=25 name="cur_ppass" maxlength="29"></div>
