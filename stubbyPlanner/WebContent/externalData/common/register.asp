...
//	}
	...
	<form name="form" action="/asp/join.asp?lang=ko&flink=&mode=new&from=b2" method="post" class="sky-form">
	<input type="hidden" name="h_url" value="">
                        ...
                        <header  style="text-align:center">회원가입 with FACEBOOK</header>                            
                            <fieldset>                  
                                <section>
			<a href="fb_login.asp?lang=ko&flink=&h_url="><img  src="/img_v8/facebook_login.png"></a>
		    </section>
		 </fieldset>
...
<script src="/chn/assets/plugins/sky-forms-pro/skyforms/js/jquery.validate.min.js"></script>
<script src="/chn/assets/plugins/sky-forms-pro/skyforms/js/jquery.maskedinput.min.js"></script>
<script src="/chn/assets/plugins/sky-forms-pro/skyforms/js/jquery-ui.min.js"></script>
<script src="/chn/assets/plugins/sky-forms-pro/skyforms/js/jquery.form.min.js"></script>

<!-- JS Implementing Plugins -->
<script type="text/javascript" src="/chn/assets/js/forms/reg.js"></script>
